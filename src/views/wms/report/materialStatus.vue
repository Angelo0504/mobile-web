<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="入库数量" align="center" prop="lkQty" />
      <el-table-column label="出库数量" align="center" prop="ckQty" />
      <el-table-column label="库存数量" align="center" prop="kcQty" />
...
<script>
import { listMaterialStatus } from "@/api/wms/materialReport";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMaterialStatus(this.queryParams).then((response) => {
    ...
    handleExport() {
      this.download(
        "system/materialReport/exportMaterialStatus",
        {
          ...this.queryParams,
        },
